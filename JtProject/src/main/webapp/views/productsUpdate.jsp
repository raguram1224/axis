			...
			<div class="row">
				<div class="col-sm-5">
					...
					<div class="form-group">
						...
						<input type="number" class="form-control border border-success" required name="price" value="Rs.{ pprice }" min="1" placeholder="Price">
					</div>
					<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="custom-file">
						<input type="file" class="custom-file-input" name="productImage" value="${ pimage }" accept="image/jpeg, image" id="productImage"/> 
