    ...
    <div class="form-container">
      <div class="personal-information">
        <h1>Payment Information</h1>
            ...
            <input id="column-left" type="Text" name="No of Products" placeholder="No of Products"/>
             <input id="column-right" type="text" name="Total Price" placeholder=" Total Price"/>
             <h3>Card Details 
             </h3>
          <input id="column" type="text" name="first-name" placeholder="Full Name"/>
